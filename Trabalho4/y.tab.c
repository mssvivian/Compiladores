...
static const yytype_int16 yyrline[] =
{
     ...
     355,   358,   367,   370,   371,   374,   376,   384,   387,   388,
     391,   393,   401,   404,   405,   408,   410,   418,   424,   433,
     435,   437,   439,   441,   443,   447,   448,   451,   452,   455,
     459,   461,   463,   465,   467,   469,   478,   480,   482,   484,
     486,   488,   490,   492,   494,   496,   498,   500,   504,   506,
     508,   510,   512,   514,   516,   518,   520,   523,   524,   525,
     526,   527,   529,   530,   532,   535,   539,   544,   551,   556,
     562,   568,   573
};
#endif
...
{
    -141,    37,   225,  -141,    11,   -27,    41,    51,    53,    21,
      33,    62,   271,  -141,  -141,  -141,  -141,    52,    88,   271,
     271,    26,    84,  -141,  -141,  -141,  -141,    35,    44,  -141,
    -141,  -141,    45,    47,    54,  -141,    70,  -141,    -7,  -141,
     -16,  -141,  -141,  -141,   109,   271,   271,   271,    85,  -141,
      74,    90,  -141,    76,    92,  -141,    80,   252,   271,  -141,
      89,   422,   -33,   -19,   -16,   -33,   -19,    27,    27,  -141,
      99,   117,   422,    87,   348,  -141,  -141,  -141,  -141,  -141,
    -141,  -141,  -141,   149,   271,   271,  -141,   271,   271,   271,
     271,   271,   271,   271,   271,  -141,   162,   271,  -141,   300,
     422,   124,   127,   362,   271,    41,   271,    51,   271,    53,
     406,  -141,   128,  -141,  -141,  -141,   411,  -141,   422,   376,
    -141,  -141,   271,   129,   135,   147,  -141,   316,   134,   435,
     101,   101,    27,    27,  -141,  -141,  -141,  -141,   332,  -141,
    -141,   271,   225,   422,  -141,   422,  -141,   422,  -141,   290,
     290,   290,   271,   290,   290,   225,   174,  -141,  -141,   271,
    -141,  -141,  -141,  -141,   422,   175,  -141,  -141,  -141,   390,
    -141,  -141,  -141,   153,   140,   148,  -141,   141,  -141,   225,
     290,   271,   159,   174,  -141,  -141,   165,   422,  -141,  -141,
     225,   186,  -141,  -141,  -141
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,    20,    97,    99,    98,   100,     0,     0,     0,
       0,     0,     0,    16,    18,     3,    15,     0,     0,     9,
      10,    11,     0,     0,     0,     8,     0,   102,     0,    87,
      96,   104,    90,    91,     0,     0,   110,     0,    45,    42,
      44,    55,    52,    54,    50,    47,    49,    36,     0,    26,
       0,    21,    88,    92,     0,    89,    93,    86,    85,    66,
       0,    68,    69,     0,     0,     4,    12,    13,     5,     6,
       7,    94,    95,     0,     0,   110,    22,     0,     0,     0,
       0,     0,     0,     0,     0,    14,     0,     0,    64,     0,
     111,     0,   108,     0,     0,     0,     0,     0,     0,     0,
      76,    40,     0,    37,    38,    39,     0,    35,    75,     0,
      23,    65,     0,     0,   101,     0,    60,     0,     0,    77,
      78,    79,    80,    81,    82,    83,    84,    62,     0,    63,
     105,   109,     0,    46,    43,    56,    53,    51,    48,     0,
       0,     0,     0,     0,     0,     0,    29,    67,   103,   110,
      19,    59,   106,    61,   112,    57,    71,    72,    70,     0,
      74,    73,    41,    32,     0,    27,    31,     0,    17,     0,
      36,     0,     0,    28,   107,    58,     0,    33,     4,    30,
       0,     0,    34,    24,    25
};
...
{
    -141,  -141,   -74,  -140,  -141,  -141,  -141,  -141,  -141,  -141,
    -141,  -141,  -141,  -141,  -141,    29,  -141,    30,  -141,  -141,
     157,   110,  -141,   163,   107,  -141,   164,   112,  -141,  -141,
      -5,  -141,   100,  -141,    55,   -12,  -141,    13,  -141,   -71,
    -141
};
...
{
       0,     1,     2,    25,    26,    75,   178,    27,    28,   156,
     194,    29,    60,   174,   175,   176,    30,   111,   112,    31,
      32,    49,    50,    33,    55,    56,    34,    52,    53,    35,
      36,    37,    70,    71,   117,    38,    39,    40,    41,   101,
     102
};
...
{
      61,   125,   165,    44,    45,    46,    86,    67,    68,    72,
      74,    47,    63,    66,   128,   172,    87,    83,    84,    85,
      96,    97,    88,    89,    90,    91,    92,    93,    94,     4,
      64,    64,    95,    99,   100,   103,    42,     3,    43,   185,
      13,    14,    15,    16,    48,   118,   119,    44,    45,    46,
     192,    17,   116,    18,    51,    62,    54,    19,    20,    57,
      92,    93,    94,    21,    22,    59,    13,    14,    15,    16,
      69,    58,   127,   100,    76,   129,   130,   131,   132,   133,
     134,   135,   136,    77,    78,   138,    79,     4,   177,    21,
      22,    65,   143,    80,   145,    81,   147,    82,    13,    14,
      15,    16,    13,    14,    15,    16,    83,    84,    85,    17,
      72,    18,    98,   104,   191,    19,    20,   105,   106,   107,
     108,    21,    22,   109,    73,    21,    22,   120,   123,   164,
      -1,    -1,    90,    91,    92,    93,    94,   118,   118,   118,
     169,   118,   118,   121,   116,   116,   116,   100,   116,   116,
       4,     5,   126,     6,     7,     8,     9,    10,    11,    12,
     122,    13,    14,    15,    16,   137,   140,   152,   118,   187,
     141,   158,    17,   159,    18,   116,   162,   173,    19,    20,
     179,   181,   182,   184,    21,    22,    23,    24,   160,     4,
       5,   183,     6,     7,     8,     9,    10,    11,    12,   188,
      13,    14,    15,    16,   166,   167,   168,   190,   170,   171,
     186,    17,   189,    18,   113,   144,   148,    19,    20,   146,
     114,   115,   157,    21,    22,    23,    24,   193,     4,     5,
       0,     6,     7,     8,     9,    10,    11,    12,     0,    13,
      14,    15,    16,     0,     0,     0,     0,     0,     0,     0,
      17,     0,    18,     0,     0,   110,    19,    20,     6,     7,
       8,     0,    21,    22,    23,    24,    13,    14,    15,    16,
       0,     0,     0,     0,     4,     0,     0,    17,     0,    18,
       0,     0,     0,    19,    20,    13,    14,    15,    16,    21,
      22,     0,     0,   110,     0,     0,    17,     0,    18,     0,
       0,     0,    19,    20,    13,    14,    15,    16,    21,    22,
       0,     0,     0,     0,     0,    17,     0,    18,     0,     0,
       0,    19,    20,    87,     0,     0,     0,    21,    22,    88,
      89,    90,    91,    92,    93,    94,     0,     0,     0,    87,
       0,     0,     0,     0,   139,    88,    89,    90,    91,    92,
      93,    94,     0,     0,     0,    87,     0,     0,     0,     0,
     161,    88,    89,    90,    91,    92,    93,    94,     0,     0,
       0,    87,     0,     0,     0,     0,   163,    88,    89,    90,
      91,    92,    93,    94,     0,    87,     0,     0,     0,     0,
     124,    88,    89,    90,    91,    92,    93,    94,     0,    87,
       0,     0,     0,     0,   142,    88,    89,    90,    91,    92,
      93,    94,     0,    87,     0,     0,     0,     0,   155,    88,
      89,    90,    91,    92,    93,    94,     0,     0,     0,   180,
     149,    42,   150,    43,   151,   153,    81,     0,    82,   154,
       0,     0,    44,    45,    46,    87,     0,    83,    84,    85,
       0,    88,    89,    90,    91,    92,    93,    94,    -1,     0,
...
{
      12,    75,   142,    36,    37,    38,    13,    19,    20,    21,
      22,    38,    17,    18,    85,   155,    23,    36,    37,    38,
      36,    37,    29,    30,    31,    32,    33,    34,    35,     3,
      17,    18,    39,    45,    46,    47,    25,     0,    27,   179,
      14,    15,    16,    17,     3,    57,    58,    36,    37,    38,
     190,    25,    57,    27,     3,     3,     3,    31,    32,    38,
      33,    34,    35,    37,    38,     3,    14,    15,    16,    17,
      44,    38,    84,    85,    39,    87,    88,    89,    90,    91,
      92,    93,    94,    39,    39,    97,    39,     3,   159,    37,
      38,     3,   104,    39,   106,    25,   108,    27,    14,    15,
      16,    17,    14,    15,    16,    17,    36,    37,    38,    25,
     122,    27,     3,    28,   188,    31,    32,    43,    28,    43,
      28,    37,    38,    43,    40,    37,    38,    38,    41,   141,
      29,    30,    31,    32,    33,    34,    35,   149,   150,   151,
     152,   153,   154,    44,   149,   150,   151,   159,   153,   154,
       3,     4,     3,     6,     7,     8,     9,    10,    11,    12,
      43,    14,    15,    16,    17,     3,    42,    39,   180,   181,
      43,    42,    25,    38,    27,   180,    42,     3,    31,    32,
       5,    28,    42,    42,    37,    38,    39,    40,    41,     3,
       4,    43,     6,     7,     8,     9,    10,    11,    12,    40,
      14,    15,    16,    17,   149,   150,   151,    42,   153,   154,
     180,    25,   183,    27,    57,   105,   109,    31,    32,   107,
      57,    57,   122,    37,    38,    39,    40,    41,     3,     4,
      -1,     6,     7,     8,     9,    10,    11,    12,    -1,    14,
      15,    16,    17,    -1,    -1,    -1,    -1,    -1,    -1,    -1,
      25,    -1,    27,    -1,    -1,     3,    31,    32,     6,     7,
       8,    -1,    37,    38,    39,    40,    14,    15,    16,    17,
      -1,    -1,    -1,    -1,     3,    -1,    -1,    25,    -1,    27,
      -1,    -1,    -1,    31,    32,    14,    15,    16,    17,    37,
      38,    -1,    -1,     3,    -1,    -1,    25,    -1,    27,    -1,
      -1,    -1,    31,    32,    14,    15,    16,    17,    37,    38,
      -1,    -1,    -1,    -1,    -1,    25,    -1,    27,    -1,    -1,
      -1,    31,    32,    23,    -1,    -1,    -1,    37,    38,    29,
      30,    31,    32,    33,    34,    35,    -1,    -1,    -1,    23,
      -1,    -1,    -1,    -1,    44,    29,    30,    31,    32,    33,
      ...
      24,    25,    26,    27,    28,    24,    25,    -1,    27,    28,
      -1,    -1,    36,    37,    38,    23,    -1,    36,    37,    38,
...
static const yytype_int8 yystos[] =
{
      ...
      32,    37,    38,    39,    40,    48,    49,    52,    53,    56,
      61,    64,    65,    68,    71,    74,    75,    76,    80,    81,
      82,    83,    25,    27,    36,    37,    38,    38,     3,    66,
      67,     3,    72,    73,     3,    69,    70,    38,    38,     3,
      57,    80,     3,    75,    82,     3,    75,    80,    80,    44,
      77,    78,    80,    40,    80,    50,    39,    39,    39,    39,
      39,    25,    27,    36,    37,    38,    13,    23,    29,    30,
      31,    32,    33,    34,    35,    39,    36,    37,     3,    80,
      80,    84,    85,    80,    28,    43,    28,    43,    28,    43,
       3,    62,    63,    65,    68,    71,    75,    79,    80,    80,
      38,    44,    43,    41,    42,    47,     3,    80,    84,    80,
      80,    80,    80,    80,    80,    80,    80,     3,    80,    44,
      42,    43,    42,    80,    66,    80,    72,    80,    69,    24,
      26,    28,    39,    24,    28,    42,    54,    77,    42,    38,
      41,    44,    42,    44,    80,    48,    79,    79,    79,    80,
      79,    79,    48,     3,    58,    59,    60,    84,    51,     5,
      39,    28,    42,    43,    42,    48,    62,    80,    40,    60,
      42,    47,    48,    41,    55
};
...
#line 1827 "y.tab.c"
  ...
  case 47: /* CMD_VAR: VAR VAR_VARs  */
#line 384 "mini_js.y"
                       { yyval.c = yyvsp[0].c; }
#line 1833 "y.tab.c"
    break;

  case 48: /* VAR_VARs: VAR_VAR ',' VAR_VARs  */
#line 387 "mini_js.y"
                                { yyval.c = yyvsp[-2].c + yyvsp[0].c; }
#line 1839 "y.tab.c"
    break;
...
#line 1918 "y.tab.c"
  ...
  case 63: /* LVALUEPROP: ID '[' E ']'  */
#line 442 "mini_js.y"
            { yyval.c = yyvsp[-3].c + "@" + yyvsp[-1].c; }
#line 1924 "y.tab.c"
    break;

  case 64: /* LVALUEPROP: ID '.' ID  */
#line 444 "mini_js.y"
            { yyval.c = yyvsp[-2].c + "@"  + yyvsp[0].c[0] ; }
#line 1930 "y.tab.c"
    break;
...
#line 2050 "y.tab.c"
  ...
  case 88: /* UN: MAIS_MAIS ID  */
#line 505 "mini_js.y"
        {yyval.c = yyvsp[0].c + yyvsp[0].c + "@" + "1" + "+" + "=";}
#line 2056 "y.tab.c"
    break;

  case 89: /* UN: MENOS_MENOS ID  */
#line 507 "mini_js.y"
        {yyval.c = yyvsp[0].c + yyvsp[0].c + "@" + "1" + "-" + "=";}
#line 2062 "y.tab.c"
    break;

  case 90: /* UN: ID MAIS_MAIS  */
#line 509 "mini_js.y"
        {yyval.c = yyvsp[-1].c + "@" + yyvsp[-1].c + yyvsp[-1].c + "@" + "1" + "+" + "=" + "^";}
#line 2068 "y.tab.c"
    break;

  case 91: /* UN: ID MENOS_MENOS  */
#line 511 "mini_js.y"
        {yyval.c = yyvsp[-1].c + "@" + yyvsp[-1].c + yyvsp[-1].c + "@" + "1" + "-" + "=" + "^";}
#line 2074 "y.tab.c"
    break;

  case 92: /* UN: MAIS_MAIS LVALUEPROP  */
#line 513 "mini_js.y"
        {yyval.c = yyvsp[0].c + yyvsp[0].c + "[@]" + "1" + "+" + "[=]";}
#line 2080 "y.tab.c"
    break;

  case 93: /* UN: MENOS_MENOS LVALUEPROP  */
#line 515 "mini_js.y"
        {yyval.c = yyvsp[0].c + yyvsp[0].c + "[@]" + "1" + "-" + "[=]";}
#line 2086 "y.tab.c"
    break;

  case 94: /* UN: LVALUEPROP MAIS_MAIS  */
#line 517 "mini_js.y"
        {yyval.c = yyvsp[-1].c + "[@]" + yyvsp[-1].c + yyvsp[-1].c + "[@]" + "1" + "+" + "[=]" + "^";}
#line 2092 "y.tab.c"
    break;

  case 95: /* UN: LVALUEPROP MENOS_MENOS  */
#line 519 "mini_js.y"
        {yyval.c = yyvsp[-1].c + "[@]" + yyvsp[-1].c + yyvsp[-1].c + "[@]" + "1" + "-" + "[=]" + "^";}
#line 2098 "y.tab.c"
    break;
